...
public class GetProbes {
    private String rootURL;

    public GetProbes(String rootURL) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // start the task
        GetProbes task = new GetProbes(rootURL);
        task.execute(token);
    }

    private void execute(String token) {
        RestApiConnectionUtils.doGet(rootURL + "dataflowmanagement/probes?queriedprobedesc=123", token,  "query probe which description contains 123");
    }
}
